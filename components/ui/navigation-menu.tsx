...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "left-0 top-0 w-full data-[animate=in]:fade-in data-[animate=out]:fade-out data-[animate=in]:slide-in-from-top-[-10px] data-[animate=out]:slide-out-to-top-[-10px] data-[state=open]:animate-in data-[state=closed]:animate-out md:absolute md:w-auto ",
      className,
    )}
    {...props}
  />
